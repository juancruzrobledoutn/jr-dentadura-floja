...
export function resetAllStores(): void {
  ...
  useWaiterAssignmentStore.setState({ overview: null, isLoading: false, error: null })
  useExclusionStore.setState({ categoryExclusions: [], subcategoryExclusions: [], isLoading: false, error: null })
